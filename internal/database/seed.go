...
func Seed() {
	...
	if ticketCount == 0 {
		...
		extraTickets := []struct {
			...
			{"NA281026-2001", "Công ty Cổ phần Mỏ Đá TTC", "Công ty CP Đầu Tư Xây Dựng 319", "29C-345.67", "Xe ben 4 chân Sinotruk", "Trần Đình Trọng", "0984.112.334", "Cân bán hàng", "confirmed", "Đã chốt số", "16.20", "46.20", "30.00", "30.00", "7.200.000 đ", "08:15", "08:42", "28/10/2026", "Nguyễn Văn Dũng", "Đá 1x2 Bê tông", "TCVN 7570:2006", "DO-319-082", "Trạm Cân 01 (100 Tấn)", "Cổng Cân Số 1", "Chuyến vận chuyển xe 29C-345.67", 16.20, 240000, "MO-PT-01"},
			{"NA251026-2012", "Công ty Cổ phần Mỏ Đá TTC", "Tổng Công Ty XD Trường Sơn", "19H-056.22", "Xe ben Chenglong", "Nguyễn Văn Mạnh", "0982.145.882", "Cân bán hàng", "confirmed", "Đã chốt số", "14.80", "46.20", "31.40", "31.40", "5.652.000 đ", "08:30", "08:58", "25/10/2026", "Nguyễn Văn Dũng", "Đá Base Cấp Phối Dmax25", "TCVN 8859:2011", "DO-TS-045", "Trạm Cân 01 (100 Tấn)", "Cổng Cân Số 1", "Chuyến vận chuyển cao tốc", 14.80, 180000, "MO-PT-01"},
			{"NA281025-22", "Công ty Cổ phần Mỏ Đá TTC", "Công ty CP Đầu Tư Xây Dựng 319", "29C-345.67", "Xe ben 4 chân Sinotruk", "Trần Đình Trọng", "0984.112.334", "Cân bán hàng", "confirmed", "Đã chốt số", "16.42", "46.42", "30.00", "30.00", "7.200.000 đ", "13:59", "14:25", "28/10/2026", "Trần Văn Cân 01", "Đá 1x2 Xây Dựng", "TCVN 7570:2006", "DO-319-083", "Trạm Cân Cổng 01", "Cổng Cân Số 1", "Cảnh báo lệch bì kiểm định +220kg", 16.42, 240000, "MO-PT-01"},
			{"NA281025-14", "Công ty Cổ phần Mỏ Đá TTC", "Công ty Bê Tông Việt Trì", "29H-882.19", "Xe bồn trộn 12m3", "Lê Văn Tuấn", "0912.445.667", "Cân bán hàng", "confirmed", "Đã chốt số", "16.23", "46.23", "30.00", "30.00", "7.800.000 đ", "10:15", "10:45", "28/10/2026", "Nguyễn Văn Dũng", "Cát Nghiền Nhân Tạo", "Mô đun độ lớn 2.6", "DO-VT-014", "Trạm Cân Cổng 01", "Cổng Cân Số 1", "Xuất mỏ bình thường", 16.23, 260000, "MO-PT-01"},
			{"NA271025-88", "Công ty Cổ phần Mỏ Đá TTC", "Tổng Công Ty XD Trường Sơn", "19H-056.22", "Xe ben Chenglong", "Nguyễn Văn Mạnh", "0982.145.882", "Cân bán hàng", "confirmed", "Đã chốt số", "16.18", "47.58", "31.40", "31.40", "5.652.000 đ", "16:20", "16:50", "27/10/2026", "Trần Văn Cân 01", "Đá Base Cấp Phối Dmax25", "TCVN 8859:2011", "DO-TS-046", "Trạm Cân Cổng 02", "Cổng Cân Số 2", "Chuyến chiều", 16.18, 180000, "MO-PT-01"},
			{"NA271025-45", "Công ty Cổ phần Mỏ Đá TTC", "Công ty CP Đầu Tư Xây Dựng 319", "88H-042.27", "Xe ben 4 chân", "Trần Đình Trọng", "0984.112.334", "Cân bán hàng", "confirmed", "Đã chốt số", "16.21", "49.39", "33.18", "33.18", "7.963.200 đ", "11:05", "11:35", "27/10/2026", "Nguyễn Văn Dũng", "Đá 1x2 Xây Dựng", "TCVN 7570:2006", "DO-319-084", "Trạm Cân Cổng 01", "Cổng Cân Số 1", "Xuất mỏ đủ tải", 16.21, 240000, "MO-PT-01"},
			{"NA261025-19", "Công ty Cổ phần Mỏ Đá TTC", "Tổng Công Ty XD Trường Sơn", "76C-102.34", "Xe đầu kéo mooc ben", "Vũ Quốc Đạt", "0978.556.223", "Cân bán hàng", "confirmed", "Đã chốt số", "16.19", "46.19", "30.00", "30.00", "5.400.000 đ", "08:40", "09:10", "26/10/2026", "Nguyễn Văn Dũng", "Đá Base Cấp Phối Dmax25", "TCVN 8859:2011", "DO-TS-047", "Trạm Cân Cổng 01", "Cổng Cân Số 1", "Xuất mỏ bình thường", 16.19, 180000, "MO-PT-01"},
			{"NA281025-23", "Công ty Cổ phần Mỏ Đá TTC", "Công ty CP Tập Đoàn Đèo Cả", "29E-380.15", "Xe tải ben 4 chân", "Hoàng Văn Hậu", "0963.221.789", "Cân bán hàng", "confirmed", "Đã chốt số", "15.80", "48.20", "32.40", "32.40", "7.128.000 đ", "14:15", "14:48", "28/10/2026", "Lê Văn Cân 02", "Đá 4x6 Kè Móng", "Đá 4x6 tuyển", "DO-DC-099", "Trạm Cân 01 (100 Tấn)", "Cổng Cân Số 1", "Phiếu điều chỉnh khối lượng", 15.80, 220000, "MO-PT-01"},
			{"HN281026-001", "Công ty Cổ phần Mỏ Đá TTC - Chi nhánh Hà Nam", "Công ty CP Xi Măng Vicem Bút Sơn", "90C-128.45", "Xe đầu kéo mooc ben Howo", "Đinh Văn Toàn", "0915.223.789", "Cân bán hàng", "confirmed", "Đã chốt số", "17.10", "49.50", "32.40", "32.40", "7.776.000 đ", "08:10", "08:35", "28/10/2026", "Phạm Kiên Quyết", "Đá Vôi Nguyên Khai 10-40mm", "TCVN 6072:2013", "DO-HN-001", "Trạm Cân Kiện Khê 120T", "Cổng Cân Số 1", "Cung cấp clinker xi măng", 17.10, 240000, "MO-HN-03"},
			{"HN281026-002", "Công ty Cổ phần Mỏ Đá TTC - Chi nhánh Hà Nam", "Tổng Công Ty Xây Dựng Số 1 (CC1)", "35C-089.12", "Xe ben 4 chân Shacman", "Bùi Đức Thịnh", "0972.441.902", "Cân bán hàng", "confirmed", "Đã chốt số", "16.50", "48.20", "31.70", "31.70", "8.242.000 đ", "09:20", "09:48", "28/10/2026", "Phạm Kiên Quyết", "Đá 1x2 Bê Tông Cầu Giẽ", "TCVN 7570:2006", "DO-HN-002", "Trạm Cân Kiện Khê 120T", "Cổng Cân Số 1", "Xuất hàng dự án cao tốc", 16.50, 260000, "MO-HN-03"},
			{"HN271026-003", "Công ty Cổ phần Mỏ Đá TTC - Chi nhánh Hà Nam", "Bê Tông Phủ Lý - Xuân Thành", "90C-054.67", "Xe bồn trộn bê tông 12m3", "Nguyễn Hoàng Long", "0981.332.654", "Cân bán hàng", "confirmed", "Đã chốt số", "15.90", "43.50", "27.60", "27.60", "7.176.000 đ", "14:15", "14:40", "27/10/2026", "Phạm Kiên Quyết", "Cát Nhân Tạo VSI Kiện Khê", "Mô đun 2.6", "DO-HN-003", "Trạm Cân Kiện Khê 120T", "Cổng Cân Số 2", "Cát bê tông mác 400", 15.90, 260000, "MO-HN-03"},
			{"TU281026-001", "Công ty Cổ phần Mỏ Đá TTC - Chi nhánh Bình Dương", "Công ty CP Bê Tông Becamex", "61C-445.89", "Xe ben 4 chân Sinotruk", "Lê Quốc Bảo", "0903.551.234", "Cân bán hàng", "confirmed", "Đã chốt số", "16.30", "48.10", "31.80", "31.80", "8.586.000 đ", "08:45", "09:12", "28/10/2026", "Võ Văn Thọ", "Đá 1x2 Xây Dựng Becamex", "TCVN 7570:2006", "DO-TU-001", "Trạm Cân Tân Uyên 100T", "Cổng Cân Số 1", "Cung cấp hạ tầng VSIP", 16.30, 270000, "MO-TU-02"},
			{"TU281026-002", "Công ty Cổ phần Mỏ Đá TTC - Chi nhánh Bình Dương", "Tập đoàn Đèo Cả (Vành Đai 3)", "60C-312.78", "Xe đầu kéo mooc ben", "Trương Văn Nam", "0938.667.129", "Cân bán hàng", "confirmed", "Đã chốt số", "17.80", "52.30", "34.50", "34.50", "7.590.000 đ", "10:30", "11:00", "28/10/2026", "Võ Văn Thọ", "Đá Base Cấp Phối Vành Đai 3", "TCVN 8859:2011", "DO-TU-002", "Trạm Cân Tân Uyên 100T", "Cổng Cân Số 1", "Dự án đường Vành Đai 3 TP.HCM", 17.80, 220000, "MO-TU-02"},
		}
		for _, t := range extraTickets {
			Pool.Exec(ctx, `
				...
				ON CONFLICT (id) DO UPDATE SET quarry_code = EXCLUDED.quarry_code
			`, t.ID, t.BenBan, t.BenMua, t.BienSo, t.LoaiXe, t.LaiXe, t.Sdt, t.Loai, t.Stage, t.StageLabel, t.CanL1, t.KL1, t.KL2, t.KL2, t.KLHang, t.KLTinhTien, t.DonGia, t.ThanhTien, t.Time1, t.Time2, t.Date, t.NguoiCan1, t.MatHang, t.QuyCach, t.DOCode, t.TramCan, t.CongCan, t.GhiChu, t.QuarryCode)
		}
	}
	...
	Pool.Exec(ctx, `
		UPDATE tickets SET
			...
			ELSE chatter END,
			quarry_code = CASE
				WHEN id LIKE 'HN%' OR tram_can LIKE '%Kiện Khê%' THEN 'MO-HN-03'
				WHEN id LIKE 'TU%' OR tram_can LIKE '%Tân Uyên%' THEN 'MO-TU-02'
				WHEN id LIKE 'BP%' OR tram_can LIKE '%Chơn Thành%' THEN 'MO-BP-04'
				WHEN quarry_code IS NOT NULL AND quarry_code != '' THEN quarry_code
				ELSE 'MO-PT-01'
			END
	`)
	...
	miningQueries := []string{
		...
		`INSERT INTO crusher_plants (plant_code, plant_name, capacity_ton_per_hour, input_rock_today_tons, power_consumption_kwh, kwh_per_ton, yield_breakdown, quarry_code) VALUES
		('PLANT-PT-01', 'Dây Chuyền Nghiền Sàng Phú Thọ 01 (350T/h)', 350, 2680, 3216, 1.20, '[{"productName":"Đá 1x2 bê tông tiêu chuẩn","producedTons":1340,"yieldPercent":50,"standardRate":48},{"productName":"Đá 4x6 móng công trình","producedTons":804,"yieldPercent":30,"standardRate":32},{"productName":"Cát nghiền nhân tạo (Mạt đá)","producedTons":402,"yieldPercent":15,"standardRate":14},{"productName":"Đá mi bụi sàng tuyển","producedTons":134,"yieldPercent":5,"standardRate":6}]'::jsonb, 'MO-PT-01'),
		('PLANT-PT-02', 'Dây Chuyền Nghiền Sàng Phú Thọ 02 (250T/h)', 250, 1850, 2312, 1.25, '[{"productName":"Đá 1x2 sàng tuyển mác cao","producedTons":925,"yieldPercent":50,"standardRate":48},{"productName":"Đá 2x4 đổ bê tông","producedTons":555,"yieldPercent":30,"standardRate":30},{"productName":"Cát nhân tạo VSI","producedTons":277,"yieldPercent":15,"standardRate":16},{"productName":"Bột đá phụ gia","producedTons":93,"yieldPercent":5,"standardRate":6}]'::jsonb, 'MO-PT-01'),
		('PLANT-HN-01', 'Dây Chuyền Nghiền Côn Kiện Khê HN-01 (450T/h)', 450, 3420, 4104, 1.20, '[{"productName":"Đá 1x2 Kiện Khê xuất khẩu","producedTons":1710,"yieldPercent":50,"standardRate":48},{"productName":"Đá 2x4 đổ dầm cầu","producedTons":1026,"yieldPercent":30,"standardRate":32},{"productName":"Cát nghiền VSI Kiện Khê","producedTons":513,"yieldPercent":15,"standardRate":14},{"productName":"Bột đá siêu mịn","producedTons":171,"yieldPercent":5,"standardRate":6}]'::jsonb, 'MO-HN-03'),
		('PLANT-HN-02', 'Dây Chuyền Nghiền Cát Nhân Tạo VSI HN-02 (200T/h)', 200, 1520, 2128, 1.40, '[{"productName":"Cát bê tông module lớn 2.6","producedTons":912,"yieldPercent":60,"standardRate":58},{"productName":"Cát xây tô mịn","producedTons":456,"yieldPercent":30,"standardRate":32},{"productName":"Bột khoáng filler","producedTons":152,"yieldPercent":10,"standardRate":10}]'::jsonb, 'MO-HN-03'),
