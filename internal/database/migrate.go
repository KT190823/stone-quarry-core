...
func Migrate() {
	...
	alters := []string{
		...
		`ALTER TABLE inventory_inbound ADD COLUMN IF NOT EXISTS quarry_name TEXT DEFAULT 'Công ty CP TTC - Mỏ đá Phú Thọ'`,
		`ALTER TABLE inventory_outbound ADD COLUMN IF NOT EXISTS quarry_code TEXT DEFAULT 'MO-PT-01'`,
		`ALTER TABLE inventory_outbound ADD COLUMN IF NOT EXISTS quarry_name TEXT DEFAULT 'Công ty CP TTC - Mỏ đá Phú Thọ'`,
		...
		`ALTER TABLE production_stages ADD COLUMN IF NOT EXISTS quarry_code TEXT DEFAULT 'MO-PT-01'`,
		`ALTER TABLE production_stages ADD COLUMN IF NOT EXISTS quarry_name TEXT DEFAULT 'Công ty CP TTC - Mỏ đá Phú Thọ'`,
		`ALTER TABLE resource_taxes ADD COLUMN IF NOT EXISTS quarry_code TEXT DEFAULT 'MO-PT-01'`,
		`ALTER TABLE resource_taxes ADD COLUMN IF NOT EXISTS quarry_name TEXT DEFAULT 'Công ty CP TTC - Mỏ đá Phú Thọ'`,
		`ALTER TABLE statutory_reports ADD COLUMN IF NOT EXISTS quarry_code TEXT DEFAULT 'MO-PT-01'`,
		`ALTER TABLE statutory_reports ADD COLUMN IF NOT EXISTS quarry_name TEXT DEFAULT 'Công ty CP TTC - Mỏ đá Phú Thọ'`,
		`ALTER TABLE inventory_stocktake ADD COLUMN IF NOT EXISTS quarry_code TEXT DEFAULT 'MO-PT-01'`,
		`ALTER TABLE inventory_stocktake ADD COLUMN IF NOT EXISTS quarry_name TEXT DEFAULT 'Công ty CP TTC - Mỏ đá Phú Thọ'`,
		`ALTER TABLE inventory_movements ADD COLUMN IF NOT EXISTS quarry_code TEXT DEFAULT 'MO-PT-01'`,
		`ALTER TABLE inventory_movements ADD COLUMN IF NOT EXISTS quarry_name TEXT DEFAULT 'Công ty CP TTC - Mỏ đá Phú Thọ'`,
		...
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS rong DOUBLE PRECISION DEFAULT 2.35`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS cao DOUBLE PRECISION DEFAULT 2.15`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS the_tich DOUBLE PRECISION DEFAULT 46.5`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS so_truc TEXT DEFAULT '4 chân (8x4)'`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS tong_tai DOUBLE PRECISION DEFAULT 30.0`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS dong_co TEXT DEFAULT 'Weichai / Sinotruk 371HP'`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS dinh_muc_co_tai DOUBLE PRECISION DEFAULT 39.0`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS dinh_muc_khong_tai DOUBLE PRECISION DEFAULT 26.5`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS hang_sx TEXT DEFAULT 'CNHTC HOWO'`,
		`ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS nam_sx INTEGER DEFAULT 2023`,

		// Vehicle catalogs specifications
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS dai DOUBLE PRECISION DEFAULT 9.2`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS rong DOUBLE PRECISION DEFAULT 2.35`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS cao DOUBLE PRECISION DEFAULT 2.15`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS the_tich DOUBLE PRECISION DEFAULT 46.5`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS tong_tai DOUBLE PRECISION DEFAULT 30.0`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS bi DOUBLE PRECISION DEFAULT 15.0`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS hang_sx TEXT DEFAULT 'HOWO Sinotruk'`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS dong_co TEXT DEFAULT '371 HP'`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS dinh_muc_co_tai DOUBLE PRECISION DEFAULT 39.0`,
		`ALTER TABLE vehicle_catalogs ADD COLUMN IF NOT EXISTS dinh_muc_khong_tai DOUBLE PRECISION DEFAULT 26.5`,
	}
